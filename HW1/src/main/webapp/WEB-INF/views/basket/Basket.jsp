...
<body>
	...
	<div class="right-align">
		...
		<a href="./Shop">구매하러 가기</a> &nbsp;| &nbsp; <a
			href="./OrderList">구매내역</a> &nbsp;| &nbsp; <a ref="./Logout">로그아웃</a>
	</div>
		...
		<c:if test="${not empty sessionScope.basketMap}">
			<c:forEach var="entry" items="${sessionScope.basketMap}">
				<tr>
					...
					<td><img src="./resources/${entry.key}.jpg">
					    <br>${entry.key}
					</td>
						
					<td id="${entry.key}">${entry.value}
					</td>
	...
	<div class="center-align">
		<a href="./OrderInsert" class="button">주문하기</a>
	</div>
