...
public class BoardDAO { // 게시판 데이터베이스를 처리하는 클래스
	Connection con;
	...
	public int boardReply(BoardBean board) {
		...
		int re_ref = board.getBOARD_RE_REF(); // 답변 그룹번호
		int re_lev = board.getBOARD_RE_LEV(); // 답변 계층 답변 달리면 +1
		int re_seq = board.getBOARD_RE_SEQ(); // 답변 순서
