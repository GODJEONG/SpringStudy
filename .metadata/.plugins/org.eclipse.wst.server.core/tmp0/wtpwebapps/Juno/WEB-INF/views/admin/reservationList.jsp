	...
	<div id="wrap">
		...
		<div id="container">
			<div class="sub_visual">
				...
				<div class="sub_visual_text">예약현황</div>
			</div>
			<!-- 
									...
									<tbody>
										<c:forEach var="reservations" items="${reservations}">
											<tr>
												...
												<td><fmt:formatDate value="${reservations.reservationTime}" pattern="yyyy-MM-dd HH:mm" /></td>
												<td>${reservations.reservationStatus}</td>
												<td>${reservations.memberName}</td>
												<td>${reservations.branchName}</td>
												<td>${reservations.designerName}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
