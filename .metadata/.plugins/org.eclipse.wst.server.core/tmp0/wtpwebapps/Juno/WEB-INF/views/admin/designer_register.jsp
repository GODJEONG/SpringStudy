...
<body class="join">
	<div id="wrap">
		...
		<div id="container">
			...
			<form id="join" action="./RegisterManagerAction"
				...
				<table>
					...
					<tr>
						...
						<td class="valuefield"><select id="branchName"
							name="branchName">
					...
					<tr>
						<!-- 이름 -->
						<td class="division">프로필 사진:</td>
						<td class="valuefield"><input type="file" id="profile"
							name="profile"></td>
					</tr>
				</table>
				...
				<div class="form_right">
					<input type="submit" class="button" value="디자이너 등록" />
				</div>
			</form>
