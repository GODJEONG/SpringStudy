...
<link rel="stylesheet" type="text/css" href="./shop_basket2/join/join_css.css">
<script src="./shop_basket2/join/verify.js"></script>
...
<body>
	...
	<br>
	<hr>
	<form id="join" action="./JoinAction.lo" method=post>
