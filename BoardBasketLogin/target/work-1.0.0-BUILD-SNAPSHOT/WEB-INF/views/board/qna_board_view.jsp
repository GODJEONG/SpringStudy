	...
	<table cellpadding="0" cellspacing="0">
		...
		<tr align="center" valign="middle">
			<td colspan="5"><font size=2> <a
					href="./BoardReply.bo?num=${boarddata.BOARD_NUM }<%-- <%=board.getBOARD_NUM()%> --%>"> [답변] </a>&nbsp;&nbsp;
					<a href="./BoardModify.bo?num=${boarddata.BOARD_NUM }<%-- <%=board.getBOARD_NUM()%> --%>"> [수정]
				</a>&nbsp;&nbsp; <a
					href="./BoardDelete.bo?num=${boarddata.BOARD_NUM }<%-- <%=board.getBOARD_NUM()%> --%>"> [삭제] </a>&nbsp;&nbsp;
