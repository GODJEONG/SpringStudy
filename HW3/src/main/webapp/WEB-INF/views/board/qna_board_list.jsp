			...
			<tr align="center" valign="middle" bordercolor="#333333"
				...
				<td style="font-family: Tahoma; font-size: 10pt;">
                    ...
                    ▶
						...
						<a href="./BoardDetailAction?num=${bl.BOARD_NUM}">${bl.BOARD_SUBJECT}</a>
					</div>
				</td>
...
<tr align="center" height="20">
    <td colspan="7" style="font-family: Tahoma; font-size: 10pt;">
        <c:choose>
            ...
            <c:otherwise>
                <a href="./BoardList?page=${page - 1}">[이전]</a>&nbsp;
            </c:otherwise>
        </c:choose>
        ...
        <c:forEach var="a" begin="${startpage}" end="${endpage}">
            <c:choose>
                ...
                <c:otherwise>
                    <a href="./BoardList?page=${a}">[<c:out value="${a}"/>]</a>&nbsp;
                </c:otherwise>
            </c:choose>
        </c:forEach>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <a href="./BoardList?page=${page + 1}">[다음]</a>
            </c:otherwise>
        </c:choose>
    </td>
</tr>
