...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/join_css.css">
	...
	<form id="join" action="JoinProcess.jsp" method=post>
		...
		<table>
			...
			<tr>
				...
				<td class="valuefield">${join.socialsecuritynumber}
					${socialsecuritynumber }</td>
			</tr>

			<tr>
				<!-- 생일 -->
				<td class="division">생일:</td>
				<td class="valuefield">${join.year} ${year }년 ${join.month}
					${month } 월 ${join.day} ${day } 일</td>
			</tr>
