...
function verification() {
	if (ID_Check() && PW_Check() && PW_DoubleCheck() && ID_PW_Check() && Name_Check() && SocialSecurityNumber_Check() && Email_Check() && Interest_Check() && Intro_Check()) {
/*		window.open("mailto:sjung8009@naver.com?subject=회원가입 정보입니다.", "메일 전송");*/
		Birthdate_Insert();
